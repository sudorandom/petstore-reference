module github.com/example/pets
...
require (
	...
	github.com/sudorandom/fauxrpc v0.28.0 // indirect
	github.com/sudorandom/protojsonx v0.0.8 // indirect
	github.com/sudorandom/protojsonx/protojsonxconnect v0.0.0-20260721214515-374626bc07d2 // indirect
